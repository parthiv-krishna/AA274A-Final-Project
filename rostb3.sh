echo "!!!!!!!!!!!!!!!!!!!!\nEdit this file (~/catkin_ws/src/final_project/scripts/rostb3.sh) to replace <turtlebot_name> and <network_interface> below, then comment this line out by preceding it with a #\n!!!!!!!!!!!!!!!!!!!!"
